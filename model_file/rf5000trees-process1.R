...
bug_list <- list("Ind","Lec","Lon","Maz","Mex","Neo","Pro","Rub")#("San","Ger","Rec","Dim")#,"Ind","Lec","Lon","Maz","Mex","Neo","Pro","Rub")
number_replicate <- 10
top_file_dir <- "/Users/liting/Documents/GitHub/r_chagasM/output/rf-5000trees/pixel_buffer_off" # add an rf layer
