...
library("caret")
library("Metrics")
source("/Users/liting/Documents/GitHub/r_chagasM/pre-testing/process-data.R")
...
top_file_dir <- "/Users/liting/Documents/GitHub/r_chagasM/output/test_new_kfold"
...
for (this_bug in bug_list){
  ...
  #read the occurence
  occ_raw_path <- "/Users/liting/Desktop/test_data/spthin_thinned_thin.csv"
