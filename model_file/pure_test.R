...
pca_stack_path = "/Users/vivianhuang/Desktop/R-modeling-scripts/r_chagasM/output/kfold_grid_process/San/result/kfold_input_data_pcaSan.RDS"
pp_pca <- readRDS(pca_stack_path)
pp_pca_rotation <- pp_pca[["rotation"]]
sort(abs(pp_pca_rotation[,1]))
